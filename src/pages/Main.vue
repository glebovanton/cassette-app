      ...
      >
        ...
        <div class="intro">
          ...
          <div class="side side-right">
            ...
            <div
              class="col-xs-12 align-center sec-pad-left sec-pad-right padding-top-md-75 padding-top-xs-40 main-content text-center"
            >
              <!--Logo-->
              <header class="logo padding-top-xs-30">
              ...
              <!--main content-->
              <section
                class="intro-text  padding-top-lg-100 padding-top-md-75 padding-top-xs-30"
              >
                <div class="ani-wrap ">
                ...
                <div class="ani-wrap ">
                  <h5 class="animated slideInUp">пример заголовка</h5>
                </div>
                <p class="col-lg-10 col-sm-12 pad-zero align-center">
                  An experimental music concert celebrating art & music. It has
                  brought you not only the best in local talent but also the
                ...
                <section class="margin-top-xs-20">
                  <!--Notify Sec-->
                  <div class="notify-btn main-menu float-left">
                    <a class="btn btn-default  md-trigger" href="tel:+375293905354"
                      ><span class="button-label text-left"
                        >позвонить</span
                      >
        ...
        <!--Right Section-->
        <PageRight :isContactsOpened="isContactsOpened" />
        <!--/Right Section-->
      </div>
      <!-- /Splitlayout -->
    </div>
...
.side-right {
  ...
  background: transparent url("../statics/img/mainbg.jpg") no-repeat fixed
    center;
}
