...
export default {
  ...
  mounted() {
    if (
      typeof localStorage.isOfertaOpened !== "undefined" &&
      localStorage.isOfertaOpened !== null
    ) {
      this.isOfertaOpened = JSON.parse(localStorage.isOfertaOpened);
    }
  },
  watch: {
    isOfertaOpened(newValue) {
      localStorage.isOfertaOpened = newValue;
    }
  },
  methods: {
    makeAppointment() {
      if (this.$refs.pageRight.$refs.cassetteForm.$refs.cassetteForm) {
        this.$refs.pageRight.$refs.cassetteForm.$refs.cassetteForm.focus();
      }
      this.isContactsOpened = !this.isContactsOpened;
    },
    trigerOferta() {
      this.isOfertaOpened = !this.isOfertaOpened;
    }
  }
};
</script>
  ...
  <div class="main-wrapper body">
    ...
    <div class="pad-zero">
      ...
      >
          ...
          <div class="side side-left">
            ...
            <div class="call-to-action about">
              <div @click="isInfoOpened = !isInfoOpened">
                <span
                  class="goto-next"
                  :class="{ 'opacity-hide': isInfoOpened }"
                >
                  Инфо о нас
          ...
          <div class="side side-right">
            ...
            >
              <div>
                <span
                  class="goto-next"
                  :class="{ 'opacity-hide': isContactsOpened }"
                >
                  Контакты
                  <span class="add-sep"></span>
                </span>
            ...
            >
              ...
              <section class="intro-text">
                ...
                <p class="col-lg-10 col-sm-12 align-center cloud thin ">
                  Любовь к жизни начинается с музыки...
                </p>
                ...
                <section class="margin-top-xs-20">
                  ...
                  <div class="notify-btn main-menu">
                    <a
                      ...
                      href="tel:+375257972452"
                      ><span class="button-label">позвонить</span>
                      <span class="mask"></span
                    ></a>
                    <span class="btn btn-default md-trigger left"
                      ><span class="button-label" @click="makeAppointment"
                        >Записаться</span
                      >
                      <span class="mask"></span
                    ></span>
        ...
        <!--Right Section-->
        <PageRight :isContactsOpened="isContactsOpened" ref="pageRight" />
        <!--/Right Section-->
      </div>
      <!-- /Splitlayout -->
    </div>
    <!-- /Container -->
    <Oferta v-if="isOfertaOpened" @trigerOferta="trigerOferta" />
  </div>
</template>
...
.side-right {
  ...
  background: transparent url("../statics/img/mainbg2.jpg") no-repeat fixed
    center;
}
